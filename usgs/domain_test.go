...
// HTTP behaviour is covered in usgs_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "usgs://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("usgs", "about")
	if err != nil || got.String() != "usgs://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want usgs://page/about", got.String(), err)
	}
}
