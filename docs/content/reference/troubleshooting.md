...
Most of these come down to network reality or how usgs serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

usgs rate-limits like any public site. usgs already paces
...
Where a surface is gated, usgs reads a cookie or token you supply
...
`usgs`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what usgs actually did
